...
# Here is an example how we define the graph of human skeleton with 26 nodes.(1-22 for MoCap and 23-26 for EMG)
# node 23 is between node 1 and 2; node 24 is between node 1 and 5; 
# node 25 is between node 9 and 10; node 26 is between node 9 and 15(According to the attacted position and human body structure)
# 1. define the 26X26 adjacency matrix .
...
# 2. define the diagonal 26X26 degree matrix.
    Degree = np.zeros((26, 26))
    Degree[0, 0] = 3
    Degree[1, 1] = 2
    Degree[2, 2] = 2
    Degree[3, 3] = 1
