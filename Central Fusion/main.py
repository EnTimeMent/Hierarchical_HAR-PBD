...
for valid_patient in range(13,31):
    ...
    X_mocap_train, X_emg_train, y_train = train_data_load('F:/Dissertation Project/CoordinateData/data',valid_patient)
    #original validation data
    X_mocap_valid, X_emg_valid, y_valid = val_data_load('F:/Dissertation Project/CoordinateData/data',valid_patient)
    ...
    #print(mocap_graphtrain.shape)
    #print(emg_graphtrain.shape)
    #print(mocap_graphvalid.shape)
    #print(emg_graphvalid.shape)
